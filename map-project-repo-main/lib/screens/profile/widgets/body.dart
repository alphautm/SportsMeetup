...
import 'package:porcupine_project/services/spring_framework.dart/spring_user.dart';
...
class _BodyState extends State<Body> {
  ...
  getData() async {
    springUser = await getSpringUser("Token", 1);
  }
